...
function FollowModalSearchbar({
  ...
  return (
    <div className="myinfo-follow-modal-search-area">
      <div className="myinfo-follow-modal-search">
        <input
          type="text"
          placeholder="검색"
          value={searchText}
...
FollowModalSearchbar.propTypes = {
...
export default FollowModalSearchbar;
