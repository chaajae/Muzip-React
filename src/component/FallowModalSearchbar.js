...
function FallowModalSearchbar({
  ...
  return (
    <div className="myinfo-fallow-modal-search-area">
      <div className="myinfo-fallow-modal-search">
        <input
          type="text"
          placeholder="검색"
          value={searchText}
...
FallowModalSearchbar.propTypes = {
...
export default FallowModalSearchbar;
