...
export const WriteComponent = (props) => {
    ...
    const [itemLock,setLock] = useState(false);
    ...
    const loadImg = (e) => {
        ...
        if(e.target.files.length == 1){
            ...
            reader.onload = function(ev){
               ...
               if((imgs[index] && imgs[index] != imageUrl+"img-upload.png")){
                imgs[index] = ev.target.result;
                selectedFiles[index] = files;
                setImgs([...imgs]);
                setSelectedFiles([...selectedFiles])
                   return;
               }   
              imgs[index] = ev.target.result;
                    if(e.target.value != "" && (imgs.length < 5)  ){
                        setImgs([...imgs,imageUrl+"img-upload.png"]);
                        setSelectedFiles([...selectedFiles,files])
                    }
                    if(imgs[e.target.className] != imageUrl+"img-upload.png" && (imgs.length == 5)){
                        setImgs([...imgs]);
                        setSelectedFiles([...selectedFiles,files]);
                    }
                }
...
const deleteImg = (index) => {
    let updateselectedFiles = [...selectedFiles];
    updateselectedFiles.splice(index,1);
    let updatedMoreImg = [...imgs];
    updatedMoreImg.splice(index,1); 
    
    let num = 0;
    for(let i = 0 ; i < updatedMoreImg.length; i++){
        if(updatedMoreImg[i] == imageUrl+"img-upload.png"){
            num++;
        }
    }

    if(updatedMoreImg.length == 4 && num == 0){
        updatedMoreImg = [...updatedMoreImg,imageUrl+"img-upload.png"];
    }
    
    setImgs(updatedMoreImg);
...
const [musicResource,setMusicResource] = useState();

function setMusicNo(musicNo,musicArtist,musicTitle){
    ...
    return(
        <div id="home-feed">
            <div id="writeBodyWrap">
                    <div id="writeHeader"><h4>새 게시물</h4></div>
                    ...
                    <div id="writeImgSourceWrap">
                        ...
                        {imgs.map((item,index) => {
                                return(
                                   ...
                                   <svg xmlns="http://www.w3.org/2000/svg" onClick={() => deleteImg(index)}  width="30" height="30" fill="currentColor" className="bi bi-trash" viewBox="0 0 16 16">
                                   <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5Zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5Zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6Z"/>
                                   <path d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1ZM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118ZM2.5 3h11V2h-11v1Z"/>
                                   </svg>
                                   </div> 
                                   : ""}
                                       <img id={"writeFileImg"+index}  src={item}/>
                                   </div>
                                       </label> 
                                )
                            })}
                            ...
                            <form encType="multipart/form-data" onSubmit={(e) =>insertFeedItem(e)}>
                                ...
                                <input type="hidden" name="insertImgs" value={imgs}/>
                                <input type="hidden" name="boardMusicNo" value={mNo}/>
                                <input type="hidden" name="fileLevel" />
                                
                                <div id="writeTextWrap">
                                    <textarea id="writeTextarea" name="feedTextContent" value={newFeedItem.feedTextContent} onChange={newFeedInputChange} style={sessionStorage.getItem("darkMode") == "Y" ? {color:"white"}:{}} required></textarea>
                                </div>
                                ...
                                <div className="modal-content writeModal ">
                                    <div className="modal-body">
                                        ...
                                        <div id="write-music-searchbar">
                                            ...
                                            <span>
                                            <svg onClick={searchMusic} xmlns="http://www.w3.org/2000/svg" width="20" height="20"fill="white" className="bi bi-search" viewBox="0 0 16 16">
